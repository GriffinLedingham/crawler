...
Dungeon.prototype.generate = function (size) {
    this.clear();
    this.map_size = size;
...
Dungeon.prototype.buildTree = function (root) {
...
Dungeon.prototype.joinRooms = function () {
    var join;
...
Dungeon.prototype.getMap = function () {
    return this.map;
}
...
Dungeon.prototype.getTree = function () {
    return this.tree;
}

Dungeon.prototype.getStats = function () {
    return this.stats;
}
